...
class _ChartCandlestick extends Component {
  componentDidMount() {
  ...
  render() {
    return (
      <Fragment>
        ...
        <div>Video for watching and audition</div>
        <PlayList/>
      </Fragment>
    );
  }
...
export const ChartCandlestick = connect(mapStateToProps, mapDispatchToProps)(_ChartCandlestick);
