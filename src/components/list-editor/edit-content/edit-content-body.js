...
class _EditContentBody extends Component {
  componentDidMount() {
...
export const EditContentBody = connect(mapStateToProps, mapDispatchToProps)(_EditContentBody);
